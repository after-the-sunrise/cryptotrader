...
public class BitfinexServiceTest {
    ...
    @Test
    public void testBitfinexMicroEstimator() {

        BitfinexService.BitfinexMicroEstimator target = new BitfinexService.BitfinexMicroEstimator();

        assertEquals(target.get(), "BitfinexMicroEstimator");
