...
import static com.after_sunrise.cryptocurrency.cryptotrader.service.quoinex.QuoinexService.ID;
import static com.after_sunrise.cryptocurrency.cryptotrader.service.quoinex.QuoinexService.ProductType.BTC_JPY;
 ...
 * @version 0.0.1
 */
public class QuoinexContextTest {

    private QuoinexContext target;

    @BeforeMethod
    public void setUp() throws Exception {
        target = spy(new QuoinexContext());
    }
